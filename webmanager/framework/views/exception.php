...
<div class="container">
	...
	<p class="message">
		<?php echo nl2br(htmlspecialchars($data['message'],ENT_QUOTES,\Sky\Sky::$app->charset))?>
	</p>

	<div class="source">
		<p class="file"><?php echo htmlspecialchars($data['file'],ENT_QUOTES,\Sky\Sky::$app->charset)."({$data['line']})"?></p>
		...
		<tr class="trace <?php echo $cssClass; ?>">
			...
			<td class="content">
				<div class="trace-file">
					...
					<?php
						echo '&nbsp;';
						echo htmlspecialchars($trace['file'],ENT_QUOTES,\Sky\Sky::$app->charset)."(".$trace['line'].")";
						echo ': ';
						if(!empty($trace['class']))
							echo "<strong>{$trace['class']}</strong>{$trace['type']}";
						echo "<strong>{$trace['function']}</strong>(";
						if(!empty($trace['args']))
							echo htmlspecialchars($this->argumentsToString($trace['args']),ENT_QUOTES,\Sky\Sky::$app->charset);
						echo ')';
					?>
				</div>
